...
var Particle = function () {
    function Particle(x, y, radius, color) {
        ...
        this.y = y;
        this.velocity = {
            x: (0, _utils.randomIntFromRange)(-2, 2),
            y: (0, _utils.randomIntFromRange)(-2, 2)
        };
        this.radius = radius;
        this.color = color;
        this.opacity = 0;
    ...
    _createClass(Particle, [{
        ...
        value: function update(particles) {
            for (var i = 0; i < particles.length; i++) {
                ...
                if ((0, _utils.distance)(this.x, this.y, particles[i].x, particles[i].y) - this.radius * 2 < 0) {
            ...
            if ((0, _utils.distance)(mouse.x, mouse.y, this.x, this.y) < 150 && this.opacity < 1) {
                this.opacity += 0.02;
...
function init() {
    ...
    for (var i = 0; i < 100; i++) {
        var radius = (0, _utils.randomIntFromRange)(15, 15);
        ...
        if (i !== 0) {
            for (var j = 0; j < particles.length; j++) {
                if ((0, _utils.distance)(x, y, particles[j].x, particles[j].y) - radius * 2 < 0) {
...
init();
animate();
},{"./utils.js":"utils.js"}],"../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/canvas.532861b6.map